...
The cleaned dataset was stored in a new table called `reservations_cleaned`, which served as the foundation for further analysis.
...
- `sql/` - folder containing SQL scripts:
  - `data_preparing.sql` - SQL script for data cleaning and transformation with descriptive comments
  - `exploratory_data_analysis.sql` - SQL queries for EDA with descriptive comments
